...
def plot_loss_heatmap_on_pitch(
    ...
    """Shared PLOT-12 loss heatmap in the transition-team frame."""
    from src.visualization.transition_heatmap import (
        plot_transition_heatmap,
    )

    # Kept for callback compatibility only. Under the shared coordinate
    # contract home/away does not change geometry.
    del losing_team_is_away
